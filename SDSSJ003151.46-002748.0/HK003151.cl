...
# Data filename prefix: S20130719S
# File numbers:
#      Telluric (HIP 116886)      : 520-523 (HK, HK, 2pix-slit, 2s)
...
#     ...    print "HK003151: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK003151: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("HK003151: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK003151: Creating the reduction lists")
...
gemlist "S20130719S" "520-523"   > "tel.lis"
