...
# File numbers:
#      Science                    : 31-34   (HK, HK, 2pix-slit, 300s)
#      Darks for science          : 26      (300s, **S20131028**  #WARNING: only one)
#      Flat                       : 36      (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : 32-37   (4s, **S20131024**)
#      Arc                        : 35      (HK, HK, 2pix-slit, 90s)
...
# Data filename prefix: S20131027S
# File numbers:
#      Telluric (HIP 13917)       : 46-49   (HK, HK, 2pix-slit, 30s)
...
#     ...    print "HK023318: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK023318: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("HK023318: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK023318: Creating the reduction lists")
gemlist "S20131027S" "36"      > "flat.lis"
gemlist "S20131024S" "32-37" > "flatdark.lis"
gemlist "S20131027S" "35"     > "arc.lis"
gemlist "S20131026S" "797-803" > "arcdark.lis"
gemlist "S20131027S" "31-34" > "obj.lis"
gemlist "S20131028S" "26" > "objdark.lis"
gemlist "S20131027S" "46-49"   > "tel.lis"
