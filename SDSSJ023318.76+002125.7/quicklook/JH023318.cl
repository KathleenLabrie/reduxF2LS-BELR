...
# Science Dataset:
#
# Observation UT date : 2013 Oct 27
# Data filename prefix: S20131027S
# File numbers:
#      Science                    : 37-40   (JH, JH, 2pix-slit, 300s)
#      Darks for science          : 26	    (300s, **S20131028**)  #WARNING: only one.
...
#     ...    print "JH023318: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH023318: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("JH023318: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH023318: Creating the reduction lists")
gemlist "S20131027S" "42"      > "flat.lis"
gemlist "S20131024S" "38-43" > "flatdark.lis"
gemlist "S20131027S" "41"     > "arc.lis"
