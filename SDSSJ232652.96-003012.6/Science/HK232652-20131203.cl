...
# Science Dataset:
#
# Observation UT date : 2013 Dec 03, *2013 Dec 05
# Data filename prefix: S20131203S, *S20131205S
# File numbers:
#      Science                    : 048-051 (HK, HK, 2pix-slit, 90s)
#      Darks for science          : 240-246 (90s)
#      Flat                       : 053     (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : *027-033 (4s)
#      Arc                        : 052     (HK, HK, 2pix-slit, 90s)
#      Darks for arc              : 240-246 (90s)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Dec 03, *2013 Dec 05, **2013 Dec 04
# Data filename prefix: S20131203S, *S20131205S, **S20121204
# File numbers:
#      Telluric (HIP 112179)      : 027-030 (HK, HK, 2pix-slit, 5s)
#      Darks for telluric         : **111-117 (5s)
#      Flat                       : 0053     (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : *027-033 (4s)
#      Arc                        : 052     (HK, HK, 2pix-slit, 90s)
#      Darks for arc              : 240-246 (90s)
...
#     ...    print "HK232652: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK232652: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("HK232652: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK232652: Creating the reduction lists")
gemlist "S20131203S" "053"      > "flat.lis"
gemlist "S20131205S" "027-033" > "flatdark.lis"
gemlist "S20131203S" "052"     > "arc.lis"
gemlist "S20131203S" "240-246" > "arcdark.lis"
gemlist "S20131203S" "048-051" > "obj.lis"
gemlist "S20131203S" "240-246" > "objdark.lis"
gemlist "S20131203S" "027-030"   > "tel.lis"
gemlist "S20131204S" "111-117"     > "teldark.lis"
