...
# File numbers:
#      Science                    : 054-057 (JH, JH, 2pix-slit, 90s)
#      Darks for science          : 240-246 (90s)
#      Flat                       : 059     (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : *034-040 (8s)
#      Arc                        : 058     (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : *020-026 (30s)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Dec 03, *2013 Dec 05
# Data filename prefix: S20131203S, *S20131205S
# File numbers:
#      Telluric (HIP 112179)      : 038-041 (JH, JH, 2pix-slit, 2s)
#      Darks for telluric         : 247-260 (2s)
#      Flat                       : 059     (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : *034-040 (8s)
#      Arc                        : 058     (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : *020-026 (30s)
...
#     ...    print "JH232652: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH232652: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("JH232652: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH232652: Creating the reduction lists")
gemlist "S20131203S" "059"      > "flat.lis"
gemlist "S20131205S" "034-040" > "flatdark.lis"
gemlist "S20131203S" "058"     > "arc.lis"
gemlist "S20131205S" "020-026" > "arcdark.lis"
gemlist "S20131203S" "054-057" > "obj.lis"
gemlist "S20131203S" "240-246" > "objdark.lis"
gemlist "S20131203S" "038-041"   > "tel.lis"
gemlist "S20131203S" "247-260"     > "teldark.lis"
