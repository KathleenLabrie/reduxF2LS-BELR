...
# Science Dataset:
#
#####   Super QuickLook -> while they are observing, Pick any darks.
#
# Observation UT date : 2013 Dec 14
# Data filename prefix: S20131214S
# File numbers:
#      Science                    : 144-147 (JH, JH, 2pix-slit, 90s)
#      Darks for science          : 797-803 (90s, **S20131026**)
#      Flat                       : 149      (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : 38-43   (8s, **S20131024**)
#      Arc                        : 148     (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : 804-810 (30s, **S20131026**)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Dec 14
# Data filename prefix: S20131214S
# File numbers:
#      Telluric (HIP 112179)      : 158-161   (JH, JH, 2pix-slit, 30s)
...
#     ...    print "JH220749: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH220749: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("JH220749: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH220749: Creating the reduction lists")
gemlist "S20131214S" "149"      > "flat.lis"
gemlist "S20131024S" "38-43" > "flatdark.lis"
gemlist "S20131214S" "148"     > "arc.lis"
gemlist "S20131026S" "804-810" > "arcdark.lis"
gemlist "S20131214S" "144-147" > "obj.lis"
gemlist "S20131026S" "797-803" > "objdark.lis"
gemlist "S20131214S" "158-161"   > "tel.lis"
