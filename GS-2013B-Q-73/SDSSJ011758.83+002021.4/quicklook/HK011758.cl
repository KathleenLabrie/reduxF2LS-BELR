...
# File numbers:
#      Science                    : 32-35   (HK, HK, 2pix-slit, 90s)
#      Darks for science          : 159-165 (90s)
#      Flat                       : 37      (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : 173-179 (4s)
#      Arc                        : 45      (HK, HK, 2pix-slit, 45s)
#      Darks for arc              : 166-172 (30s, ** no 45s darks available)
#
# Telluric Dataset:
#
...
# Data filename prefix: S20131015S
# File numbers:
#      Telluric (HIP 6061)        : 18-21   (HK, HK, 2pix-slit, 2s)
...
#     ...    print "HK011758: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK011758: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("HK011758: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK011758: Creating the reduction lists")
gemlist "S20131015S" "37"      > "flat.lis"
gemlist "S20131015S" "173-179" > "flatdark.lis"
gemlist "S20131015S" "45"     > "arc.lis"
gemlist "S20131015S" "166-172" > "arcdark.lis"
gemlist "S20131015S" "32-35" > "obj.lis"
gemlist "S20131015S" "159-165" > "objdark.lis"
gemlist "S20131015S" "18-21"   > "tel.lis"
gemlist "S20131015S" "152-154,156-158"     > "teldark.lis"  # 155 has a bad section
...
# !!!! flat appears to be quite faint
