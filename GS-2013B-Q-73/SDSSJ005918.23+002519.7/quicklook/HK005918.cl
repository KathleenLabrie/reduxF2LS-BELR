...
# Data filename prefix: S20131026S
# File numbers:
#      Telluric (HIP 13917)       : 699-702 (HK, HK, 2pix-slit, 30s)
...
if (access(f2.database)) {
    printf ("HK005918: Deleting contents of %s\n", f2.database)
...
specplot ("xtfobj_comb.fits[sci,1],axtfobj_comb.fits[sci,1],\
          xtftel_comb.fits[sci,1]", fraction=0.0025, yscale=yes, ymin=-100, ymax=1000)
