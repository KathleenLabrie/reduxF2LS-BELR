...
# File numbers:
#      Science                    : 138-141 (HK, HK, 2pix-slit, 90s)
#      Darks for science          : 797-803 (90s, **S20131026**)
#      Flat                       : 143     (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : 32-37   (4s, **S20131024**)
#      Arc                        : 142     (HK, HK, 2pix-slit, 90s)
#      Darks for arc              : 797-803 (90s, **S20131026**)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Dec 14
# Data filename prefix: S20131214S
# File numbers:
#      Telluric (HIP 112179)      : 154-157   (HK, HK, 2pix-slit, 30s)
...
#     ...    print "HK220749: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK220749: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("HK220749: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK220749: Creating the reduction lists")
gemlist "S20131214S" "143"      > "flat.lis"
gemlist "S20131024S" "32-37" > "flatdark.lis"
gemlist "S20131214S" "142"     > "arc.lis"
gemlist "S20131026S" "797-803" > "arcdark.lis"
gemlist "S20131214S" "138-141" > "obj.lis"
gemlist "S20131026S" "797-803" > "objdark.lis"
gemlist "S20131214S" "154-157"   > "tel.lis"
