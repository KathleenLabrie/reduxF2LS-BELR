...
# Science Dataset:
#
# Observation UT date : 2013 Oct 29, *2013 Nov 01
# Data filename prefix: S20131029S, *S20131101S
# File numbers:
#      Science                    : 039-042 (JH, JH, 2pix-slit, 90s)
#      Darks for science          : 178-174 (90s)
#      Flat                       : 044     (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : *046-052 (8s)
#      Arc                        : 043     (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : *074-080 (30s)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Oct 29, *2013 Nov 01, ** 2013 Oct 31
# Data filename prefix: S20131029S, *S20131101S, **S20131031S
# File numbers:
#      Telluric (HIP 2586)        : 060-063 (JH, JH, 2pix-slit, 5s)
#      Darks for telluric         : **044-049 (5s)
#      Flat                       : 044     (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : *046-052 (8s)
#      Arc                        : 043     (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : *074-080 (30s)
...
#     ...    print "JH003251: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH003251: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("JH003251: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH003251: Creating the reduction lists")
gemlist "S20131029S" "044"      > "flat.lis"
gemlist "S20131101S" "046-052" > "flatdark.lis"
gemlist "S20131029S" "043"     > "arc.lis"
gemlist "S20131101S" "074-080" > "arcdark.lis"
gemlist "S20131029S" "039-042" > "obj.lis"
gemlist "S20131029S" "178-184" > "objdark.lis"
gemlist "S20131029S" "060-063"   > "tel.lis"
gemlist "S20131031S" "044-049"     > "teldark.lis"
