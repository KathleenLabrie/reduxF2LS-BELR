...
# File numbers:
#      Science                    : 032-035 (HK, HK, 2pix-slit, 90s)
#      Darks for science          : 178-184 (90s)
#      Flat                       : 038     (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : *032-038 (4s)
#      Arc                        : 037     (HK, HK, 2pix-slit, 90s)
...
# Data filename prefix: S20131029S, *S20131101S
# File numbers:
#      Telluric (HIP 2585)        : 056-059 (HK, HK, 2pix-slit, 2s)
#      Darks for telluric         : *025-031 (2s)
#      Flat                       : 038     (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : *032-038 (4s)
#      Arc                        : 037     (HK, HK, 2pix-slit, 90s)
#      Darks for arc              : 178-184 (90s)
...
#     ...    print "HK003251: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK003251: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("HK003251: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK003251: Creating the reduction lists")
gemlist "S20131029S" "038"      > "flat.lis"
gemlist "S20131101S" "032-038" > "flatdark.lis"
gemlist "S20131029S" "037"     > "arc.lis"
gemlist "S20131029S" "178-184" > "arcdark.lis"
gemlist "S20131029S" "032-035" > "obj.lis"
gemlist "S20131029S" "178-184" > "objdark.lis"
gemlist "S20131029S" "056-059"   > "tel.lis"
gemlist "S20131101S" "025-031"     > "teldark.lis"
