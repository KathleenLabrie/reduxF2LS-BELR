...
# File numbers:
#      Science                    : 502-505 (JH, JH, 2pix-slit, 90s)
#      Darks for science          : 592-595 (90s)
#      Flat                       : 507     (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : 540-543 (8s)
#      Arc                        : 506     (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : 560-563 (30s)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Jul 19
# Data filename prefix: S20130719S
# File numbers:
#      Telluric (HIP 116886)      : 516-519 (JH, JH, 2pix-slit, 2s)
#      Darks for telluric         : 524-527 (2s)
#      Flat                       : 507     (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : 540-543 (8s)
#      Arc                        : 506     (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : 560-563 (30s)
...
#     ...    print "JH003151: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH003151: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("JH003151: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH003151: Creating the reduction lists")
gemlist "S20130719S" "507"      > "flat.lis"
gemlist "S20130719S" "540-543" > "flatdark.lis"
gemlist "S20130719S" "506"     > "arc.lis"
gemlist "S20130719S" "560-563" > "arcdark.lis"
gemlist "S20130719S" "502-505" > "obj.lis"
gemlist "S20130719S" "592-595" > "objdark.lis"
gemlist "S20130719S" "516-519"   > "tel.lis"
gemlist "S20130719S" "524-527"     > "teldark.lis"
...
nstelluric ("xtfobj_comb.fits", "xtftel_comb", fitorder=16, threshold=0.01, \
    fl_inter=yes)

splot ("axtfobj_comb.fits[SCI,1]", ymin=-100, ymax=500)
