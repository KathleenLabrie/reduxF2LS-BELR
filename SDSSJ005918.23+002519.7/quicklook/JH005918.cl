...
# Science Dataset:
#
# Observation UT date : 2013 Oct 26
# Data filename prefix: S20131026S
# File numbers:
#      Science                    : 687-690 (JH, JH, 2pix-slit, 90s)
#      Darks for science          : 797-803	(90s)
#      Flat                       : 695     (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : 38-43   (8s, **S20131024**)
#      Arc                        : 692     (JH, JH, 2pix-slit, 15s)
#      Darks for arc              : 804-810 (30s)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Oct 26
# Data filename prefix: S20131026S
# File numbers:
#      Telluric (HIP 1378)        : 703-706 (JH, JH, 2pix-slit, 30s)
...
#     ...    print "JH005918: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH005918: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("JH005918: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH005918: Creating the reduction lists")
gemlist "S20131026S" "695"      > "flat.lis"
gemlist "S20131024S" "38-43" > "flatdark.lis"
gemlist "S20131026S" "692"     > "arc.lis"
gemlist "S20131026S" "804-810" > "arcdark.lis"
gemlist "S20131026S" "687-690" > "obj.lis"
gemlist "S20131026S" "797-803" > "objdark.lis"
gemlist "S20131026S" "703-706"   > "tel.lis"
...
# loosy telluric correction (quicklook)
