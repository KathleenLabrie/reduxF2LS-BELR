...
# Data filename prefix: S20131002S
# File numbers:
#      Science                    : 46-53   (JH, JH, 2pix-slit, 90s)
#      Darks for science          : 231-237 (90s)
#      Flat                       : 55      (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : 217-223 (8s)
#      Arc                        : 54      (JH, JH, 2pix-slit, 30s)
...
# Data filename prefix: S20131002S
# File numbers:
#      Telluric (HIP 13917)       : 63-66   (JH, JH, 2pix-slit, 30s)
#      Darks for telluric         : 37-42   (30s, *** S20131003S ***)
#      Flat                       : 55      (JH, JH, 2pix-slit, 8s)
#      Darks for flat             : 217-223 (8s)
#      Arc                        : 54      (JH, JH, 2pix-slit, 30s)
#      Darks for arc              : 203-209 (30s)
...
#     ...    print "JH022721: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH022721: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("JH022721: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH022721: Creating the reduction lists")
gemlist "S20131002S" "55"      > "flat.lis"
gemlist "S20131002S" "217-223" > "flatdark.lis"
gemlist "S20131002S" "54"     > "arc.lis"
gemlist "S20131002S" "203-209" > "arcdark.lis"
gemlist "S20131002S" "46-53" > "obj.lis"
gemlist "S20131002S" "231-237" > "objdark.lis"
gemlist "S20131002S" "63-66"   > "tel.lis"
gemlist "S20131003S" "37-42"     > "teldark.lis"
