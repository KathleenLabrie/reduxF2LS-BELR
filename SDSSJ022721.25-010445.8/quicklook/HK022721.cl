...
# File numbers:
#      Science                    : 40-43   (HK, HK, 2pix-slit, 90s)
#      Darks for science          : 231-237 (90s)
#      Flat                       : 67      (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : 210-216 (4s)
#      Arc                        : 44      (HK, HK, 2pix-slit, 90s)
#      Darks for arc              : 231-237 (90s)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Oct 02
# Data filename prefix: S20131002S
# File numbers:
#      Telluric (HIP 13917)       : 59-62   (HK, HK, 2pix-slit, 30s)
...
#     ...    print "HK022721: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK022721: Deleting contents of %s\n", f2.database)
...
rawdir = "../../../raw/"
printf ("HK022721: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK022721: Creating the reduction lists")
gemlist "S20131002S" "67"      > "flat.lis"
gemlist "S20131002S" "210-216" > "flatdark.lis"
gemlist "S20131002S" "44"     > "arc.lis"
gemlist "S20131002S" "231-237" > "arcdark.lis"
gemlist "S20131002S" "40-43" > "obj.lis"
gemlist "S20131002S" "231-237" > "objdark.lis"
gemlist "S20131002S" "59-62"   > "tel.lis"
...
concat ("flat.lis,flatdark.lis,arc.lis,obj.lis,objdark.lis,\
	tel.lis,teldark.lis", "all.lis")
#
# KL: must remove arcdark.lis because is duplicates objdark.lis
#	and f2prepare is too dumb to just skip the duplicates.
#
...
#
# KL:  Barfs and dies if a file in the input list has already been prepared.
#
