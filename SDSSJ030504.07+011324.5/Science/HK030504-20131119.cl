...
# Science Dataset:
#
# Observation UT date : 2013 Nov 19
# Data filename prefix: S20131119S
# File numbers:
#      Science                    : 044-047 (HK, HK, 2pix-slit, 90s)
#      Darks for science          : 121-127 (90s)
#      Flat                       : 049     (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : 107-113 (4s)
#      Arc                        : 048     (HK, HK, 2pix-slit, 90s)
#      Darks for arc              : 121-127 (90s)
#
# Telluric Dataset:
#
# Observation UT date : 2013 Nov 19, *2013 Nov 20
# Data filename prefix: S20131119S, *S20131120S
# File numbers:
#      Telluric (HIP 13917)       : 059-062 (HK, HK, 2pix-slit, 30s)
#      Darks for telluric         : *133-138 (30s)
#      Flat                       : 049     (HK, HK, 2pix-slit, 4s)
#      Darks for flat             : 107-113 (4s)
#      Arc                        : 048     (HK, HK, 2pix-slit, 90s)
#      Darks for arc              : 121-127 (90s)
...
#     ...    print "HK030504: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("HK030504: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("HK030504: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("HK030504: Creating the reduction lists")
gemlist "S20131119S" "049"      > "flat.lis"
gemlist "S20131119S" "1107-113" > "flatdark.lis"
gemlist "S20131119S" "048"     > "arc.lis"
gemlist "S20131119S" "121-127" > "arcdark.lis"
gemlist "S20131119S" "044-047" > "obj.lis"
gemlist "S20131119S" "121-127" > "objdark.lis"
gemlist "S20131119S" "059-062"   > "tel.lis"
gemlist "S20131120S" "133-138"     > "teldark.lis"
