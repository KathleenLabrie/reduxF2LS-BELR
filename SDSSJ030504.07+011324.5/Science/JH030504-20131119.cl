...
#     ...    print "JH030504: Deleting contents of %s" % (f2.database)
#     ...    iraf.delete (f2.database + "*", verify=no)

if (access(f2.database)) {
    printf ("JH030504: Deleting contents of %s\n", f2.database)
...
rawdir = "../../raw/"
printf ("JH030504: Raw data is located in %s\n", rawdir)
...
# their own dataset.
print ("JH030504: Creating the reduction lists")
gemlist "S20131119S" "055"      > "flat.lis"
gemlist "S20131119S" "104-120" > "flatdark.lis"
gemlist "S20131119S" "054"     > "arc.lis"
gemlist "S20131119S" "100-106" > "arcdark.lis"
gemlist "S20131119S" "050-053" > "obj.lis"
gemlist "S20131119S" "121-127" > "objdark.lis"
gemlist "S20131119S" "063-066"   > "tel.lis"
